...
If you want to make docker-compose work with previous versions of CoreOS, you need to edit the selected part of the file down below. It will alllow you to download an appropriate version of docker-compose which's target the compatible version of docker engine.
